...
function tcwidget_options_content()
{
    ...
    if (get_option(TCWIDGET_SETTINGS) == '') {
        $errorlist .= tcwidget_add_error('Please copy the settings from your account at <a href="https://www.trendcounter.com" target="_blank">https://www.trendcounter.com</a>');
...
?>
    ...
    <p>
       Please <a href="https://www.trendcounter.com/login/" target="_blank">login</a> to your trendcounter.com account (or <a href="https://www.trendcounter.com/signup/" target="_blank">signup</a> for a new one) and go to the <b>Project HTML</b> area, where you can copy your personal WordPress settings for this plugin.
    </p>
